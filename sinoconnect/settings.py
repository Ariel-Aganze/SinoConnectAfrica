"""
Django settings for SinoConnect Africa project.
"""
...
WSGI_APPLICATION = 'sinoconnect.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='sinoconnect_db'),
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@sinoconnect.com')
